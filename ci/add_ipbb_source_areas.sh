...
ipbb add git https://gitlab-ci-token:${CI_JOB_TOKEN}@gitlab.cern.ch/p2-xware/firmware/emp-fwk.git -b v0.9.3
...
ipbb add git https://gitlab-ci-token:${CI_JOB_TOKEN}@gitlab.cern.ch/dth_p1-v2/slinkrocket.git -b v03.12
