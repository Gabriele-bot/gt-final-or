...
package P2GT_finor_pkg is
    ...
    constant OUTPUT_LATENCY_ALGOBITS          : integer := 13;
    ...
    -- SLR 1
    constant SLRn0_INPUT_CHANNELS : ChannelSystemMap(INPUT_LINKS_SLR - 1 downto 0)     := (111, 110, 109, 108, 107, 106, 105, 104, 103, 102, 101, 100, 27, 26, 25, 24, 23, 22, 21, 20, 19, 18, 17, 16);
    constant SLRn0_INPUT_QUADS    : ChannelSystemMap(INPUT_LINKS_SLR / 4 - 1 downto 0) := (27, 26, 25, 6, 5, 4);
    -- SLR 2
    constant SLRn1_INPUT_CHANNELS : ChannelSystemMap(INPUT_LINKS_SLR - 1 downto 0)     := (95, 94, 93, 92, 91, 90, 89, 88, 87, 86, 85, 84, 43, 42 ,41, 40, 39, 38, 37, 36, 35, 34, 33, 32);
    constant SLRn1_INPUT_QUADS    : ChannelSystemMap(INPUT_LINKS_SLR / 4 - 1 downto 0) := (23, 22, 21, 10, 9, 8);
    -- SLR 3
    constant SLRn2_INPUT_CHANNELS : ChannelSystemMap(INPUT_LINKS_SLR - 1 downto 0)     := (75, 74, 73, 72, 71, 70, 69, 68, 67, 66, 65, 64, 63 ,62, 61, 60, 59, 58, 57, 56, 55, 54, 53, 52);
    constant SLRn2_INPUT_QUADS    : ChannelSystemMap(INPUT_LINKS_SLR / 4 - 1 downto 0) := (18, 17 , 16, 15 , 14, 13);

    -- =================================================================================
    -- OUTPUTs on SLR3 SLR2
    -- =================================================================================
    constant SLRn2_OUTPUT_CHANNELS : ChannelSystemMap(3 - 1 downto 0) := (50,49,48);
    constant SLRn2_OUTPUT_QUAD     : natural                          := 12;

    constant SLRn1_OUTPUT_CHANNELS : ChannelSystemMap(3 - 1 downto 0) := (46, 45, 44);
    constant SLRn1_OUTPUT_QUAD     : natural                          := 11;
    
    constant SLRn0_OUTPUT_CHANNELS : ChannelSystemMap(3 - 1 downto 0) := (42, 41, 40);
    constant SLRn0_OUTPUT_QUAD     : natural                          := 10;
    ...
    -- =================================================================================
    -- OUTPUTS trigger bits on SLR0
    -- =================================================================================
    constant OUTPUT_CHANNEL : natural := 4;
    constant OUTPUT_QUAD    : natural := 1;
