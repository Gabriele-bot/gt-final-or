...
if {$N_MONITOR_SLR > 2} {
	add_cells_to_pblock [get_pblock pblock_SLR_n2]  [get_cells -hierarchical -filter {NAME =~ *SLRn2_module}]
}
if {$N_MONITOR_SLR > 1} {
	add_cells_to_pblock [get_pblock pblock_SLR_n1]  [get_cells -hierarchical -filter {NAME =~ *SLRn1_module}]
}
add_cells_to_pblock [get_pblock pblock_SLR_n0]  [get_cells -hierarchical -filter {NAME =~ *SLRn0_module}]
