...
if {$DEBUG} {
    set mux_dest_SLRn0 [get_pins -of_objects [get_cells payload/*SLRn0_mux*/*input_360_reg_reg*] -filter {Name =~ */D}]
    set mux_clk_SLRn0 [get_pins -of_objects [get_cells payload/*SLRn1_mux*/*input_360_reg_reg*] -filter {Name =~ */C}]
    set mux_dest_SLRn1 [get_pins -of_objects [get_cells payload/*SLRn1_mux*/*input_360_reg_reg*] -filter {Name =~ */D}] 
    set mux_clk_SLRn1 [get_pins -of_objects [get_cells payload/*SLRn1_mux*/*input_360_reg_reg*] -filter {Name =~ */C}] 
    ...
    #TODO maybe add also the valid bit?
